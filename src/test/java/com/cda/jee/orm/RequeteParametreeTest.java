...
public class RequeteParametreeTest {
	...
	void test_sql_query() {
		...
		String typeSportPratiqueParBillRequeteStr = "select s.type from Personne p join p.sports s where p.prenom = :prenom";
		Query<String> typeSportPratiqueParBillRequete =  session.createQuery(typeSportPratiqueParBillRequeteStr, String.class);
		typeSportPratiqueParBillRequete.setParameter("prenom", "Bill");
